"""
Trainer implementations for unlearning algorithms.

Available trainers:
- GradAscentTrainer: Gradient ascent on forget set
- GradDiffTrainer: Gradient difference (ascent on forget, descent on retain)
"""
...
from .base_trainer import BaseUnlearning
